...
circom -o ./poseidon/out --r1cs --wasm --sym ./poseidon/associate_data_v2.circom

echo "[SETUP] - Setting up phase 2 ceremony"
snarkjs g16s \
    ./poseidon/out/associate_data_v2.r1cs \
    ./powers_of_tau/powersOfTau28_hez_final_13.ptau \
    ./poseidon/out/associate_data_v2_0000.zkey

echo "[SETUP] - Contributing to the ceremony"
snarkjs zkc \
    ./poseidon/out/associate_data_v2_0000.zkey \
    ./poseidon/out/associate_data_v2.zkey \
    -e='unique new york'

echo "[SETUP] - Exporting verification key to json"
snarkjs zkev \
    ./poseidon/out/associate_data_v2.zkey \
    ./poseidon/out/associate_data_v2_verifier.json